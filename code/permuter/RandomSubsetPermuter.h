#ifndef RANDOM_SUBSET_PERMUTER_H
#define RANDOM_SUBSET_PERMUTER_H
...
class RandomSubsetPermuter : public Permuter {
 public:
  RandomSubsetPermuter();
  RandomSubsetPermuter(std::vector<fs_testing::utils::disk_write> *data);
