 ...
 * 5. falloc a 4k chunk of file at offset 60k + 128 with the keep_size flag
 * 6. Crash
 *
 *
...
class Generic042FallocateKeepSizeUnaligned: public Generic042Base {
 public:
   Generic042FallocateKeepSizeUnaligned() :
...
extern "C" fs_testing::tests::BaseTestCase *test_case_get_instance() {
  return new fs_testing::tests::Generic042FallocateKeepSizeUnaligned;
}
