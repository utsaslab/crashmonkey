 ...
 * 5. punch a 4k hole in file at offset 60k + 128
 * 6. Crash
 *
 *
 ...
 * 60k + 128, the next 4k should be zero due to the punch operation, and the
...
class Generic042FpunchKeepSizeUnaligned: public Generic042Base {
 public:
   Generic042FpunchKeepSizeUnaligned() :
...
extern "C" fs_testing::tests::BaseTestCase *test_case_get_instance() {
  return new fs_testing::tests::Generic042FpunchKeepSizeUnaligned;
}
