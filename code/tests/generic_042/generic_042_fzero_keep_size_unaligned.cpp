 ...
 * 5. zero a 4k block in file at offset 60k + 128 with the keep_size flag
 * 6. Crash
 *
 *
...
class Generic042FzeroKeepSizeUnaligned: public Generic042Base {
 public:
   Generic042FzeroKeepSizeUnaligned() :
...
extern "C" fs_testing::tests::BaseTestCase *test_case_get_instance() {
  return new fs_testing::tests::Generic042FzeroKeepSizeUnaligned;
}
